...
module.exports = {
	...
	plugins: [
		...
		new FaviconsWebpackPlugin({
			...
			favicons: {
				appName: "Space-Time Hell",
				appDescription: "Space-Time Hell Game",
				developerName: "diralf",
				developerURL: "http://diralf.itch.io", // prevent retrieving from the nearest package.json
				icons: {
					coast: false,
					yandex: false,
					appleStartup: false,
